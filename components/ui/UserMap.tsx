...
const MOCK_BATHHOUSES = [
  ...
  },
  {
    ...
    rating: 5.0,
    ratingCount: 210,
    amenities: ['hot_water', 'sauna', 'massage', 'locker', 'parking', 'wifi', 'accessible'],
    status: 'approved',
  ...
  },
  {
    ...
    rating: 4.9,
    ratingCount: 88,
    amenities: ['hot_water', 'sauna', 'massage', 'locker', 'parking', 'wifi', 'laundry'],
    status: 'approved',
  ...
  return (
    <View style={styles.container}>
      <MapView
        ...
        style={styles.map}
        initialRegion={{ latitude: 10.7769, longitude: 106.7009, latitudeDelta: 0.05, longitudeDelta: 0.05 }} 
        ...
        <View style={styles.searchResultsContainer}>
            <ScrollView keyboardShouldPersistTaps="handled" style={{maxHeight: 250}}>
                {searchResults.map((item) => (
                    <TouchableOpacity key={item.id} style={styles.resultItem} onPress={() => onSelectSearchResult(item)}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{paddingHorizontal: 20, gap: 10}}>
          ...
          {FILTERS.map(f => {
            ...
            return (
                ...
                >
                <Ionicons name={f.icon as any} size={16} color={isActive ? "white" : "#555"} />
...
const styles = StyleSheet.create({
  ...
  searchWrapper: { position: 'absolute', top: 50, left: 20, right: 20, flexDirection: 'row', alignItems: 'center', gap: 10, zIndex: 10 },
  searchBar: { flex: 1, flexDirection: 'row', backgroundColor: 'white', borderRadius: 25, paddingHorizontal: 15, height: 50, alignItems: 'center', elevation: 5, shadowColor: '#000', shadowOffset: {width: 0, height: 2}, shadowOpacity: 0.2, shadowRadius: 4 },
  input: { flex: 1, fontSize: 16 },
  listButton: { backgroundColor: 'white', width: 50, height: 50, borderRadius: 25, justifyContent: 'center', alignItems: 'center', elevation: 5, shadowColor: '#000', shadowOffset: {width: 0, height: 2}, shadowOpacity: 0.2, shadowRadius: 4 },
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', paddingHorizontal: 15, paddingVertical: 8, borderRadius: 20, elevation: 3, gap: 5 },
  filterChipActive: { backgroundColor: '#039BE5' },
  filterText: { fontWeight: '600', color: '#555', fontSize: 13 },
  filterTextActive: { color: 'white' },

  myLocationBtn: { position: 'absolute', bottom: 30, right: 20, width: 50, height: 50, borderRadius: 25, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', elevation: 5, shadowColor: '#000', shadowOffset: {width: 0, height: 2}, shadowOpacity: 0.2, shadowRadius: 4 }
});